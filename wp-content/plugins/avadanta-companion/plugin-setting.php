...
elseif ( 'Teczilla' == $theme->name || 'Teczilla Consulting' == $theme->name || 'Teczilla Business' == $theme->name || 'Teczilla Agency' == $theme->name || 'Teczilla Corporate' == $theme->name || 'Teczilla startup' == $theme->name || 'Teczilla Finance' == $theme->name || 'Teczilla Dark' == $theme->name || 'Teczilla Creative' == $theme->name || 'Teczilla Trading' == $theme->name || 'Teczilla Portfolio' == $theme->name || 'Teczilla Organization' == $theme->name || 'Teczilla Industry' == $theme->name || 'Teczilla SEO' == $theme->name || 'Teczilla Marketing' == $theme->name || 'Teczilla Lite' == $theme->name || 'Teczilla Software' == $theme->name || 'Teczilla Technology' == $theme->name || 'Teczilla SAAS' == $theme->name || 'Teczilla Freelancer' == $theme->name || 'Teczilla Black' == $theme->name || 'Teczilla Multipurpose' == $theme->name){
		...
		if ( 'Teczilla Freelancer' == $theme->name ){ 
			require_once('library/teczilla/home-sections/freelancer/teczilla-slider-section.php');
		}else{
		...
		if ( 'Teczilla Creative' == $theme->name || 'Teczilla Portfolio' == $theme->name || 'Teczilla Marketing' == $theme->name || 'Teczilla Technology' == $theme->name || 'Teczilla Freelancer' == $theme->name || 'Teczilla Black' == $theme->name || 'Teczilla Multipurpose' == $theme->name){
		...
		elseif('Teczilla SEO' == $theme->name){

			require_once('library/teczilla/default-data9.php');
		}
		elseif('Teczilla Marketing' == $theme->name){

			require_once('library/teczilla/default-data2.php');
		}
		elseif('Teczilla Lite' == $theme->name){

			require_once('library/teczilla/default-data2.php');
		}
		elseif('Teczilla Software' == $theme->name){

			require_once('library/teczilla/default-data5.php');
		}
		elseif('Teczilla Technology' == $theme->name){

			require_once('library/teczilla/default-data7.php');
		}
		elseif('Teczilla SAAS' == $theme->name){

			require_once('library/teczilla/default-data2.php');
		}
		elseif('Teczilla Freelancer' == $theme->name){
			
			require_once('library/teczilla/default-data7.php');
		}
		elseif('Teczilla Black' == $theme->name){
