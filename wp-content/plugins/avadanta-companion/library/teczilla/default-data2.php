...
function avata_avadanta_get_slider_default() {
	...
	return apply_filters(
		'avadanta_slider_content', json_encode(
			array(
				array(
				'title'      => esc_html__( 'Business Case Studies.!', 'teczilla' ),
				'text'       => esc_html__('We provide company and finance service for startups and company business.', 'teczilla'),
				'link'      => '#',
                'image_url'     => esc_url(AVATA_PLUGIN_URL . 'library/teczilla/assets/images/slider3.jpg'),
				),
				array(
				'title'      => esc_html__( 'Unique Business Consulting.', 'teczilla' ),
				'text'       => esc_html__('We provide company and finance service for startups and company business.', 'teczilla'),
				'link'      => '#',
	...
	return apply_filters(
		'avadanta_testimonial_content', json_encode(
			array(
				...
				'title'      => esc_html__( 'David Fahim', 'teczilla' ),
				'subtitle'   => esc_html__( 'Web Developer', 'teczilla' ),
				'image_url'     => esc_url(AVATA_PLUGIN_URL . 'library/avadanta/assets/images/testimonial-dark-01.jpg'),
				...
				'title'      => esc_html__( 'Kiron Jorge', 'teczilla' ),
				'subtitle'   => esc_html__( 'Web Designer', 'teczilla' ),
				'image_url'     => esc_url(AVATA_PLUGIN_URL . 'library/avadanta/assets/images/testimonial-dark-02.jpg'),
				'text'       => esc_html__('Dorem ipsum dolor sit amet, consectetur adipisicing elised doingyt eiusmod teididunt ut labore et dolore eiusmod tempor.', 'teczilla'),
				),
				array(
				'title'      => esc_html__( 'Robart Jason', 'teczilla' ),
				'subtitle'   => esc_html__( 'Programmer', 'teczilla' ),
				'image_url'     => esc_url(AVATA_PLUGIN_URL . 'library/avadanta/assets/images/testimonial-dark-03.jpg'),
				'text'       => esc_html__('Dorem ipsum dolor sit amet, consectetur adipisicing elised doingyt eiusmod teididunt ut labore et dolore eiusmod tempor.', 'teczilla'),
				),				
