              ...
              <div class="carousel-inner">
                <?php $avadanta_slider_options = json_decode($avadanta_slider_options);
                    ...
                    <div class="home-slider carousel-item <?php if($count==1){ ?>active <?php }?>">
                      ...
                      <?php $theme = wp_get_theme();  if('Teczilla Marketing' == $theme->name) {?>
                        <div class="content-slide">
                            ...
                            <?php if($button!=="") { ?>
                                <div class="read-slide">
                                    <a href="<?php echo esc_url($link); ?>" class="banner-style"><?php echo esc_html($button); ?></a>
                                </div>
                            <?php } ?>
                        </div>
                        <?php }else{ ?>
                            ...
                            <div class="slider-caption d-md-block">
                                ...
                                <?php if($button!=="") { ?>
                                    <div class="slider-bottom">
                                        <ul>
                                            <li><a href="<?php echo esc_url($link); ?>" class="slider-btn banner-style"><?php echo esc_html($button); ?></a></li>
                                        </ul>
                                    </div>
                                <?php } ?>
                            </div>
