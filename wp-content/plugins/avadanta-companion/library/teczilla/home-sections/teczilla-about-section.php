...
$about_section_enable = get_theme_mod('about_section_enable','on');
		...
		$home_about_section_title = get_theme_mod('home_about_section_title',__('Who we are','avadanta'));
        
        $home_about_section_subtitle = get_theme_mod('home_about_section_subtitle','To Make Your Digital Experience Brighter.');        
           ...
           <div class="tec-about inner pt-100 lg-pt-92 md-pt-80 pb-100 md-pb-80">
                <div class="container">
                    <div class="row y-middle mb-64 lg-mb-30 md-mb-0">
                        <?php $theme = wp_get_theme();  if('Teczilla Freelancer' == $theme->name) {?>
