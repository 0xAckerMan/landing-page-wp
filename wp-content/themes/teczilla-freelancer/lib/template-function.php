<?php
function teczilla_freelancer_inline_css(){
...
$teczilla_theme_color_scheme = get_theme_mod('teczilla_theme_color_scheme','#ff3c58');               

$teczilla_custom_css      .= '.full-width-header .toolbar-area,.sec-title .sub-title.primary:after,.readon,.tec-services.style2 .service-wrap .image-part i,.bg21,.tec-portfolio.style3 .portfolio-item .content-part .middle .categories a,.tec-carousel.dot-style1 .owl-dots .owl-dot,.tec-team.inner .team-item .text-bottom .team-social ul li,#scrollUp i,#scrollUp i:hover,.tec-footer .footer-content .widget-title:before,.comment-respond .form-submit input,
...
add_action( 'wp_enqueue_scripts', 'teczilla_freelancer_inline_css',20 );

  function avadant_freelancer_custom_header_setup()
    {
        add_theme_support('custom-header', apply_filters('avadanta_custom_header_args', array(
            ...
            'height'             => 250,
            'flex-height'        => true,
            'wp-head-callback'   => 'avadanta_freelancer_header_style',
        )));
    }

    add_action( 'after_setup_theme', 'avadant_freelancer_custom_header_setup' );


if ( !function_exists('avadanta_freelancer_header_style') ) :
    /**
     * Add Header And background Images
     */
    function avadanta_freelancer_header_style()
    {        
        ?>
        <style type="text/css">
            <?php
